...
namespace GTEventGenerator
{
    public class EventEntry
    {
        ...
        public void WriteEntryBaseToBuffer(ref BitStream bs, GameDB db)
        {
            ...
            // Write car (carthin)
            int carCode = !string.IsNullOrEmpty(CarLabel) ? db.GetCarCodeByLabel(CarLabel) : -1;
        ...
        public void WriteEntryToBuffer(ref BitStream bs, GameDB db, bool isPlayer)
        {
            ...
            new EventEntry(isPlayer).WriteEntryBaseToBuffer(ref bs, db);
